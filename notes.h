...
#define  NOTE_GS3 207.65  //G#3/Ab3
...
#define STAR_WARS         20
#define TETRIS            21
#define SUPERMARIO        22
#define SUPERMARIO2       23
#define GOT               24
#define GODFATHER         25
#define HARRYPOTTER       26
#define STAR_WARS2        27
#define DOM               28
#define POKEMON           29
#define HBD               30
#define MARRYCHRIS        31
#define KEYBOARDCAT       32  
#define TAKEONME          33
#define ASABRANCA         34
#define SLEEP             35
...
const double star_Wars[] = {
  
  // Cantina BAnd - Star wars 
  // Score available at https://musescore.com/user/6795541/scores/1606876
  NOTE_B4,-4, NOTE_E5,-4, NOTE_B4,-4, NOTE_E5,-4, 
  NOTE_B4,8,  NOTE_E5,-4, NOTE_B4,8, REST,8,  NOTE_Ab4,8, NOTE_B4,8, 
  NOTE_B4,8,  NOTE_Ab4,8, NOTE_B4,8, NOTE_A4,8, REST,8, NOTE_Gb4,8, NOTE_A4,8, NOTE_G4,8,
  NOTE_G4,4,  NOTE_E4,-2, 
  NOTE_B4,-4, NOTE_E5,-4, NOTE_B4,-4, NOTE_E5,-4, 
  NOTE_B4,8,  NOTE_E5,-4, NOTE_B4,8, REST,8,  NOTE_Ab4,8, NOTE_B4,8,

  NOTE_A4,-4, NOTE_A4,-4, NOTE_Gb4,8, NOTE_A4,-4,
  ...
  NOTE_F5, -4, NOTE_E5,-4, NOTE_Ab4,8, NOTE_Ab4,8, NOTE_B4,4, NOTE_G4,4, 
  
};

const double superMario[] = {
  ...
  NOTE_A4,4, NOTE_B4,4, NOTE_Ab4,8, NOTE_A4,4,
  ...
  REST,4, NOTE_G5,8, NOTE_F5,8, NOTE_F5,8, NOTE_Db5,4, NOTE_E5,8,//7
  REST,8, NOTE_Gb4,8, NOTE_A4,8, NOTE_C4,8, REST,8, NOTE_A4,8, NOTE_C5,8, NOTE_D5,8,
  REST,4, NOTE_Db5,4, REST,8, NOTE_D5,-4,
  NOTE_C5,2, REST,2,

  REST,4, NOTE_G5,8, NOTE_F5,8, NOTE_F5,8, NOTE_Db5,4, NOTE_E5,8,//repeats from 7
  REST,8, NOTE_Gb4,8, NOTE_A4,8, NOTE_C4,8, REST,8, NOTE_A4,8, NOTE_C5,8, NOTE_D5,8,
  REST,4, NOTE_Db5,4, REST,8, NOTE_D5,-4,
  NOTE_C5,2, REST,2,
  ...
  NOTE_E5,8, NOTE_C5,4, NOTE_G4,8, REST,4, NOTE_Gb4,4,//23
  NOTE_A4,8, NOTE_F5,4, NOTE_F5,8, NOTE_A4,2,
  NOTE_D5,-8, NOTE_A5,-8, NOTE_A5,-8, NOTE_A5,-8, NOTE_G5,-8, NOTE_F5,-8,
  
  NOTE_E5,8, NOTE_C5,4, NOTE_A4,8, NOTE_G4,2, //26
  NOTE_E5,8, NOTE_C5,4, NOTE_G4,8, REST,4, NOTE_Gb4,4,
  NOTE_A4,8, NOTE_F5,4, NOTE_F5,8, NOTE_A4,2,
  NOTE_B4,8, NOTE_F5,4, NOTE_F5,8, NOTE_F5,-8, NOTE_E5,-8, NOTE_D5,-8,
  NOTE_C5,8, NOTE_E4,4, NOTE_E4,8, NOTE_C4,2,

  NOTE_E5,8, NOTE_C5,4, NOTE_G4,8, REST,4, NOTE_Gb4,4,//repeats from 23
  NOTE_A4,8, NOTE_F5,4, NOTE_F5,8, NOTE_A4,2,
  NOTE_D5,-8, NOTE_A5,-8, NOTE_A5,-8, NOTE_A5,-8, NOTE_G5,-8, NOTE_F5,-8,
...
const double superMario2[] = {
  
  //game over sound
  NOTE_C5,-4, NOTE_G4,-4, NOTE_E4,4, //45
  NOTE_A4,-8, NOTE_B4,-8, NOTE_A4,-8, NOTE_Gb4,-8, NOTE_Ab4,-8, NOTE_Gb4,-8,
...
const double got[] = {
  ...
  NOTE_G4,8, NOTE_C4,8, NOTE_Db4,16, NOTE_F4,16, NOTE_G4,8, NOTE_C4,8, NOTE_Db4,16, NOTE_F4,16, //1
  NOTE_G4,8, NOTE_C4,8, NOTE_Db4,16, NOTE_F4,16, NOTE_G4,8, NOTE_C4,8, NOTE_Db4,16, NOTE_F4,16,
  NOTE_G4,8, NOTE_C4,8, NOTE_E4,16, NOTE_F4,16, NOTE_G4,8, NOTE_C4,8, NOTE_E4,16, NOTE_F4,16,
  NOTE_G4,8, NOTE_C4,8, NOTE_E4,16, NOTE_F4,16, NOTE_G4,8, NOTE_C4,8, NOTE_E4,16, NOTE_F4,16,
  NOTE_G4,-4, NOTE_C4,-4,//5

  NOTE_Db4,16, NOTE_F4,16, NOTE_G4,4, NOTE_C4,4, NOTE_Db4,16, NOTE_F4,16, //6
  NOTE_D4,-1, //7 and 8
  NOTE_F4,-4, NOTE_Ab3,-4,
  NOTE_Db4,16, NOTE_D4,16, NOTE_F4,4, NOTE_Ab3,-4,
  NOTE_Db4,16, NOTE_D4,16, NOTE_C4,-1, //11 and 12
  ...
  NOTE_Db4,16, NOTE_D4,16, NOTE_C4,-1, //11 and 12
  NOTE_G4,-4, NOTE_C4,-4,
  NOTE_Db4,16, NOTE_F4,16, NOTE_G4,4,  NOTE_C4,4, NOTE_Db4,16, NOTE_F4,16,

  NOTE_D4,-2,//15
  NOTE_F4,-4, NOTE_Ab3,-4,
  NOTE_D4,-8, NOTE_Db4,-8, NOTE_D4,-8, NOTE_Ab3,-8,
  NOTE_C4,-1,
  NOTE_C5,-2,
  NOTE_Ab4,-2,
  NOTE_C4,-2,
  ...
  NOTE_G4,-2, 
  NOTE_Db4,-2,
  NOTE_Db4,-4, NOTE_D4,-4,
  NOTE_C5,8, NOTE_G4,8, NOTE_Gb4,16, NOTE_Ab4,16, NOTE_C5,8, NOTE_G4,8, NOTE_Gb4,16, NOTE_Ab4,16,
  NOTE_C5,8, NOTE_G4,8, NOTE_Gb4,16, NOTE_Ab4,16, NOTE_C5,8, NOTE_G4,8, NOTE_Gb4,16, NOTE_Ab4,16,
  
  REST,4, NOTE_Gb5,16, NOTE_Ab5,16, NOTE_C6,8, NOTE_G5,8, NOTE_Gb5,16, NOTE_Ab5,16,
  NOTE_C6,8, NOTE_G5,16, NOTE_Gb5,16, NOTE_Ab5,16, NOTE_C6,8, NOTE_G5,8, NOTE_Gb5,16, NOTE_Ab5,16,  
};

const double godFather[] = {
...
//int s_godFather = sizeof(godFather);

const double harryPotter[] = {
